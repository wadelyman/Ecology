...
response = requests.get(
    ...
    params={('api_key', 'KlO3ClH31KAglUHM6iNmCju58X9W7HIQR3sBpmdd'), ('system_capacity', '10'), ('module_type', '1'), ('losses', '10'), ('array_type', '1'), ('tilt', '2'), ('azimuth', '180'),
            ('address', ''), ('lat', '40'), ('lon', '-105'), ('file_id', ''), ('dataset', ''), ('radius', ''), ('timeframe', 'hourly'), ('dc_ac_ratio', ''), ('gcr', ''), ('inv_eff', ''), ('callback', '')}
)
...
formatted_result = data['outputs']['ac']
